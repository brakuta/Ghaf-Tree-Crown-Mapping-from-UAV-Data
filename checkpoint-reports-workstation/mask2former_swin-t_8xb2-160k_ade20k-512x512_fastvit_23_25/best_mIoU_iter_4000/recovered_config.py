...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='ghaf26/images', seg_map_path='ghaf26/masks'),
        data_root='C:\\ghaf',
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='ghaf_23_25/images', seg_map_path='ghaf_23_25/masks'),
        data_root='C:\\ghaf',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(reduce_zero_label=False, type='LoadAnnotations'),
...
work_dir = './work_dirs\\mask2former_swin-t_8xb2-160k_ade20k-512x512_fastvit_23_25'
