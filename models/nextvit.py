...
class NextViT(nn.Module):
    def __init__(self, stem_chs, depths, path_dropout, attn_drop=0, drop=0, num_classes=1000,
        ...
        self.stage_block_types = [[NCB] * depths[0],
                                  ...
                                  [NCB] * (depths[3] - 1) + [NTB]]
        # [[<class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NCB'>], [<class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NTB'>], 
        #[<class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NTB'>, <class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NTB'>],
        # [<class 'nextvit.NCB'>, <class 'nextvit.NCB'>, <class 'nextvit.NTB'>]]
        print('stage_block_types...',self.stage_block_types)
        ...
        print('initialize_weights...',self.stage_out_idx)# [2, 6, 36, 39] 
    ...
    def init_weights(self, pretrained=None):
        if isinstance(pretrained, str):
            ...
            print(torch.load(pretrained, map_location='cpu').keys())
    ...
    def forward(self, x):
        outputs = list()
        x = self.stem(x)
        # print("self.usecheckpoint",self.use_checkpoint)
        stage_id = 0
        for idx, layer in enumerate(self.features):
            ...
            if idx == self.stage_out_idx[stage_id]:
                ...
                stage_id += 1
        # print(outputs)
        # print(np.unique(outputs[0].detach().cpu().numpy()))
        return outputs

class NextViT_tim(nn.Module):
    def __init__(self):
        super(NextViT_tim, self).__init__()  # Ensure nn.Module is properly initialized
...
class nextvit_small_timm(NextViT_tim):
    def __init__(self, **kwargs):
        super(nextvit_small_timm, self).__init__()
