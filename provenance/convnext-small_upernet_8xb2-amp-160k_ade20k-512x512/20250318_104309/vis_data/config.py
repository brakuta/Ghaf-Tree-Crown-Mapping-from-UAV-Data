...
default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=3500, type='CheckpointHook'),
...
launcher = 'none'
load_from = 'G:\\experiments\\mmsegmentation\\work_dirs\\convnext-small_upernet_8xb2-amp-160k_ade20k-512x512convnext\\iter_14000.pth'
log_level = 'INFO'
...
work_dir = './work_dirs\\convnext-small_upernet_8xb2-amp-160k_ade20k-512x512'
